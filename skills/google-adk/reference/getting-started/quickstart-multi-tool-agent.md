...
[OS X & Linux](#os-x--linux)[Windows](#windows)
...
[OS X & Linux](#os-x--linux_1)[Windows](#windows_1)
...
[OS X & Linux](#os-x--linux_2)[Windows](#windows_2)
...
[OS X & Linux](#os-x--linux_3)[Windows](#windows_3)
...
[Gemini - Google AI Studio](#gemini---google-ai-studio)[Gemini - Google Cloud Vertex AI](#gemini---google-cloud-vertex-ai)[Gemini - Google Cloud Vertex AI with Express Mode](#gemini---google-cloud-vertex-ai-with-express-mode)
...
[Dev UI (adk web)](#dev-ui-adk-web)[Terminal (adk run)](#terminal-adk-run)[API Server (adk api\_server)](#api-server-adk-api_server)
...
[Dev UI (adk web)](#dev-ui-adk-web_1)[Terminal (adk run)](#terminal-adk-run_1)[API Server (adk api\_server)](#api-server-adk-api_server_1)
...
[Dev UI](#dev-ui)[Maven](#maven)[Gradle](#gradle)
...
* **Go to the tutorial**: Learn how to add memory, session, state to your agent:
  tutorial.
* **Delve into advanced configuration:** Explore the setup
