...
Source reference: [live\_request\_queue.py](https://github.com/google/adk-python/blob/427a983b18088bdc22272d02714393b0a779ecdf/src/google/adk/agents/live_request_queue.py)
...
### send\_content(): Sends Text With Turn-by-Turn
...
### send\_realtime(): Sends Audio, Image and Video in Real-Time
...
← Previous: Part 1: Introduction to ADK Gemini Live API Toolkit | Next: Part 3: Event Handling with run\_live() →