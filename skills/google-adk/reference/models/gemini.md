...
### Error Code 429 - RESOURCE\_EXHAUSTED
...
2. Enable client-side retries. Retries allow the client to automatically retry the request after a delay, which can help if the quota issue is temporary.
   ...
   **Option 1:** Set retry options on the Agent as a part of generate\_content\_config.
...
In this example, this option converts the built-in google\_search to a function
