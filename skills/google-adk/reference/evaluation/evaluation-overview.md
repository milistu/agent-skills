...
* **final\_response\_match\_v2**: LLM-judged semantic match to a reference
  response.
* **rubric\_based\_final\_response\_quality\_v1**: LLM-judged final response
  quality based on custom rubrics.
* **rubric\_based\_tool\_use\_quality\_v1**: LLM-judged tool usage quality based on
  custom rubrics.
* **hallucinations\_v1**: LLM-judged groundedness of agent response against
  context.
