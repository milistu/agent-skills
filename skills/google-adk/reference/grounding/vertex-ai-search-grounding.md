...
vertex\_search\_agent/agent.py
...
[Dev UI (adk web)](#dev-ui-adk-web)[Terminal (adk run)](#terminal-adk-run)
...
the dropdown. Select "vertex\_search\_agent".

Troubleshooting

If you do not see "vertex\_search\_agent" in the dropdown menu, make sure you
are running `adk web` in the **parent folder** of your agent folder
(i.e. the parent folder of vertex\_search\_agent).
